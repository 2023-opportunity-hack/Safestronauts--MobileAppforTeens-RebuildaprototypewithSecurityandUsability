    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View>
        ...
        <Image
          ...
          style={{ width: 50, height: 60, position: 'absolute', left: 80, bottom: -420, }}
          resizeMode="contain"
        />
        <Image
          source={require('./assets/cute(2).png')}
          style={{ width: 100, height: 100, position: 'absolute', right: -60, bottom: -90, }}
          resizeMode="contain"
        />
        <Image
          source={require('./assets/cute(2).png')}
            ...
            <View style={styles.buttonContainer}>
              <View style={styles.imageTextContainer}>
                <Image
                  ...
                  resizeMode="contain"
                />
                <Text style={styles.buttonText1}>Send location to contacts</Text>
              </View>
            </View>
          </TouchableOpacity>
        </View>
