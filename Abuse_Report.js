...
export default function Abuse_Report({navigation}) {
  ...
  return (
    <ScrollView>
      <View>
        <View>
          <Text style={styles.text1}>What happened?</Text>
          <TextInput
            style={styles.input1}
            value={userInput}
        ...
        <Text style={styles.text1}>When did it happen?</Text>
        <View style={styles.border0}>
          <View style={styles.border1}>
            <Text style={styles.text2}>Year of event</Text>
          ...
          <View style={styles.border1}>
            <Text style={styles.text2}>Month of event</Text>
            <Text style={styles.text2}>
              <View style={styles.container}>
          ...
          <View style={styles.border1}>
            <Text style={styles.text2}>Day of event</Text>
            <Text style={styles.text2}>
              <View style={styles.container}>
          ...
          <View style={styles.border1}>
            <Text style={styles.text2}>Time of event</Text>
            <Text style={styles.text2}>11:11</Text>
          </View>
        </View>
